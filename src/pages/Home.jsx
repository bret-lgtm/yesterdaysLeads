        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="space-y-4">
            ...
            <AccordionItem value="item-5" className="bg-white rounded-2xl border border-slate-200/60 px-6 shadow-sm">
              ...
              <AccordionContent className="text-slate-600 pb-5">
                Only once per pricing tier, which means it could be sold up to a maximum of 5 times total over several months. Unlike other aged vendors who sell the same lead hundreds of even thousands of times, we limit how many times each lead is sold to preserve its value and your competitive advantage.
              </AccordionContent>
            </AccordionItem>
