...
export const base44 = createClient({
  ...
  // This is used by auth functions to ensure they go directly
  // to the Base44 authentication service.
  ...
  // Your custom Google Client ID, pulled from Vercel environment variables.
