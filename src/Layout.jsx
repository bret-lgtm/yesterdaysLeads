...
React.useEffect(() => {
  ...
  script.innerHTML = `
    ...
    fbq('init', '347512540759870');
    fbq('track', 'PageView');
  `;
  document.head.appendChild(script);
  const noscript = document.createElement('noscript');
  noscript.innerHTML = '<img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=347512540759870&ev=PageView&noscript=1" />';
